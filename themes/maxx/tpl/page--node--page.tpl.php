<div id="wrap-all">
	...
	<div id="main-content-wrapper" class="fixed-width-wrapper">
		<?php if ($breadcrumb):?>
		<!--breadcrums-->
		<div id="breadcrumb-wrapper" class="float-left"><?php print $breadcrumb; ?></div>
		<!--/breadcrums-->
		<?php endif;?>
		...
		<div id="content" class="fullwidth-page">
			...
			<article class="post-entry">
				<!--entry content-->
				<div class="entry-content"><?php print render($page['content']); ?></div>
				<!--/entry content-->
			</article>
			<!--/post entry-->
			<div class="clear"></div>
			...
			<div id="footer-widget-content" class="fixed-width-wrapper">
				...
				<div class="one-third">
					<aside class="widget md_flickr_widget">
						...
						<div id="featured">
							<div class="section clearfix"><?php print render($page['footer_two_column']); ?></div>
						</div>
						<!-- /.section, /#featured -->
						<?php endif; ?>
					</aside>
