...
<div class="portfolio-items isotope" style="position:relative;">
	...
	<?php if (!empty($nodes)): ?>
		...
		?>
				...
				<article class="project columns  six project-entry <?php print portfolio_format_terms('field_portfolio_category', $node); ?> isotope-item">
					...
					<div class="animated fadeIn">
						...
						<?php
						  ...
						  ?>
						<?php print theme('image', array('path' => $image_uri, 'attributes' => array('class' => 'attachment-large'))); //'style_name' => $style_name,  ?>
						<?php endif; ?>
						</a></div>
