       ...
       <?php endif; ?>
         <div class="container">
          ...
          <div class="row">
            ...
            <?php if ($page['preface_first'] || $page['preface_second'] || $page['preface_third']) :?>
             <div class="row">
             <div class="preface span12 aq-block">
             <?php if ($page['preface_first']):?>
             <div class="preface-first span4">
             <?php print render($page['preface_first']); ?>
             </div>
             <?php endif; ?>
             <?php if ($page['preface_second']):?>
             <div class="preface-second span4">
             <?php print render($page['preface_second']); ?>
             </div>
             <?php endif; ?>
             <?php if ($page['preface_third']):?>
             <div class="preface-third span4">
            ...
            <?php if ($page['sidebar_first']): ?>
             <div class="span9 alignright" id="content-area">
             <?php endif; ?>
             <?php if (!$page['sidebar_first']): ?>
        ...
        <?php print render($page['content']); ?>
           ...
           <?php endif; ?>
             ...
             <div class="row">
             <div class="postscript span12">
             
             <?php if ($page['postscript_first']):?>
             <div class="postscript-first span3">
             <?php print render($page['postscript_first']); ?>
             </div>
             <?php endif; ?>
             <?php if ($page['postscript_second']):?>
             <div class="postscript-second span3">
             <?php print render($page['postscript_second']); ?>
             </div>
             <?php endif; ?>
             <?php if ($page['postscript_third']):?>
             <div class="postscript-third span3">
